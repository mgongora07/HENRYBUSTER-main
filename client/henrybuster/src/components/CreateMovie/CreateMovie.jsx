 ...
 // const history = useHistory();
  ...
  const validationHandler = () => {
    ...
    if (!name || name.length>100)
      newValidation.name = "Name can't be empty and can't contain more than 100 letters";
    else newValidation.name = "";

    if (!image)
    newValidation.image = "Image can't be empty";
  else newValidation.image = "";

  if (!description || description.length>1000)
  newValidation.description = "Description can't be empty and can't contain more than 1000 letters";
    ...
    if (!date )
    newValidation.date = "Data can't be empty";
  else newValidation.date = "";

  if (!FormatId )
    newValidation.FormatId = "Format can't be empty";
  else newValidation.FormatId = "";


  if (!LanguageId )
    newValidation.LanguageId = "Language can't be empty";
  ...
  return (
    <div className={s.formContainer}>
      <form className={s["movie-form"]}>
        ...
        {image && (<div className={s['form-group']}>
        <label>Preview:</label>
